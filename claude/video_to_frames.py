...
# Default: 30 s at 30 fps, frames named movie000_seg000_frame00000.jpg ...
python3 video_to_frames.py my_video.mp4 -o frames/

# Match a specific (movie_id, segment_id) for a particular pvc-1 condition
python3 video_to_frames.py my_video.mp4 -o frames/ -m 2 -g 15

# Skip the first 10 s of the source, take 30 s starting at t=10
python3 video_to_frames.py my_video.mp4 -s 10 -d 30

# See what ffmpeg would run without actually doing it
python3 video_to_frames.py my_video.mp4 --dry-run
"""
